...
mixin _$CreateNoteResponse {
  Note get createNote => throw _privateConstructorUsedError;
...
abstract class $CreateNoteResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({Note createNote});

  $NoteCopyWith<$Res> get createNote;
}
...
class _$CreateNoteResponseCopyWithImpl<$Res, $Val extends CreateNoteResponse>
  ...
  @override
  $Res call({
    Object? createNote = null,
  }) {
    return _then(_value.copyWith(
      createNote: null == createNote
          ? _value.createNote
          : createNote // ignore: cast_nullable_to_non_nullable
              as Note,
    ) as $Val);
  }
  ...
  @pragma('vm:prefer-inline')
  $NoteCopyWith<$Res> get createNote {
    return $NoteCopyWith<$Res>(_value.createNote, (value) {
      return _then(_value.copyWith(createNote: value) as $Val);
    });
  }
}
...
class _$_CreateNoteResponse extends _CreateNoteResponse {
  _$_CreateNoteResponse({required this.createNote}) : super._();
  ...
  @override
  String toString() {
    return 'CreateNoteResponse(createNote: $createNote)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.createNote, createNote) ||
                other.createNote == createNote));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, createNote);
...
abstract class _CreateNoteResponse extends CreateNoteResponse {
  factory _CreateNoteResponse({required final Note createNote}) =
